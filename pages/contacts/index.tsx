...
import {
  ...
  RiSearchLine, RiAddLine, RiListCheck2,
} from "react-icons/ri";
...
export default function ContactsPage({ lists, total: initialTotal }: { lists: ListOption[]; total: number }) {
  ...
  const [newContactForm, setNewContactForm] = useState({ full_name: "", linkedin_url: "", title: "", company: "", location: "", email: "", list_id: "" });
  ...
  async function createContact(e: React.FormEvent) {
    ...
    setNewContactForm({ full_name: "", linkedin_url: "", title: "", company: "", location: "", email: "", list_id: "" });
