...
Recent releases have focused on LinkedIn session safety and data quality:
...
- **Improved list organization** — campaign status & history, manual contact creation, add/remove-by-id with undo
